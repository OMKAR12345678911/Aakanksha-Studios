  ...
  return (
    <PageTransition>
      ...
      <div className='bg-black w-full min-h-[100svh] text-center justify-items-start z-10 align-top relative overflow-x-hidden md:h-[calc(100svh-5rem)] md:min-h-0 md:overflow-hidden'>
        ...
        {/* Tagline Badge */}
        <h3 className='absolute top-10 left-5 z-10 flex items-center whitespace-nowrap border-2 border-amber-200 bg-black/50 px-6 py-2 text-sm font-bold text-amber-50 backdrop-blur-xl sm:text-base rounded-4xl shadow-2xl shadow-amber-200'>
